...
class PayloadRequestTest < Minitest::Test
  ...
  def test_returns_top_referrers_for_url_less_than_3
    ...
    referrer1= Referrer.create(name: "referrer1")
    referrer2= Referrer.create(name: "referrer2")

    assert_equal ["referrer2", "referrer1"], PayloadRequest.top_three_referrers_for_url(1)
  ...
  def test_returns_top_referrers_for_url_more_than_3
    ...
    referrer1= Referrer.create(name: "referrer1")
    referrer2= Referrer.create(name: "referrer2")
    referrer3= Referrer.create(name: "referrer3")
    referrer4= Referrer.create(name: "referrer4")

    assert_equal ["referrer1", "referrer2", "referrer3"], PayloadRequest.top_three_referrers_for_url(1)
